...
console.log(exists);
conn.sendMessage(id ,`${gg} ${exists ? " existe ":" não existe"} on WhatsApp`, MessageType.text)
}
...
conn.sendMessage(id, '3aalaikumsalam, como posso ajudá-lo? se tiver confuso #help sim querida..' ,MessageType.text);
}
else if (text == 'salam'){
...
conn.sendMessage(id, 'Waalaikumsalam, como posso ajudá-lo? se estiver confuso, digite #ajuda sim diga .. ' ,MessageType.text);
}
else if (text == 'p'){
conn.sendMessage(id, 'Sim, eu posso te ajudar? se estiver confuso, digite #help yes say..' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Sim, eu posso te ajudar? se estiver confuso, digite #help yes say..' ,MessageType.text);
}
...
conn.sendMessage(id, 'Sim, eu posso te ajudar? se tipo confuso #help sim querida..' ,MessageType.text);
}
else if (text == 'Uau'){
conn.sendMessage(id, 'Sim, eu posso te ajudar? se tipo confuso #help sim querida..' ,MessageType.text);
}
...
else if (text == 'eu amo vc'){
conn.sendMessage(id, 'amo você também' ,MessageType.text);
}
else if (text == 'mas'){
conn.sendMessage(id, 'Sim, eu posso te ajudar? se tipo confuso #help sim querida..' ,MessageType.text);
}
...
conn.sendMessage(id, 'Mesmo mesmo, tenha um bom dia :)' ,MessageType.text);
}
else if (text == 'obrigado'){
conn.sendMessage(id, 'Mesmo mesmo, tenha um bom dia :)' ,MessageType.text);
}
...
conn.sendMessage(id, 'Você é o mesmo, tenha um bom dia :)' ,MessageType.text);
}
else if (text == 'obrigado'){
conn.sendMessage(id, 'De nada, tenha um bom dia:)' ,MessageType.text);
}
...
var tampilTanggal = "ENCONTRO: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
...
/*   if (text.includes("#yt"))
   ...
   {
    var items = ["menina Ulzzang "," menina bonita "," véu lindo "," menina coreana"];
   ...
   {
    var items = ["rapaz bonito "," cogan "," menino coreano "," menino chinês "," menino japonês"];
    var cewe = items[Math.floor(Math.random() * items.length)];
    var url = "https://api.fdci.se/rep.php?gambar=" + cewe;
...
if (text.includes("#randomanime"))
   {
    var items = ["anime girl "," beautiful anime "," anime "," anime estética"];
    var cewe = items[Math.floor(Math.random() * items.length)];
    var url = "https://api.fdci.se/rep.php?gambar=" + cewe;
